...
namespace implemented
{
    ...
    public:
        ...
        Camera(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up, int distanceToTarget)
        {
            Set(position, center, up, distanceToTarget);
        }
        ...
        // Update camera
        void Set(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up, int distanceToTarget)
        {
        ...
        void SetDistanceToTarget(int distanceToTarget) {
            this->distanceToTarget = distanceToTarget;
        }
